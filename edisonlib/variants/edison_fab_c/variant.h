...
#define LINUX_SERIAL2_TTY		"/dev/ttyMFD2"
...
//macros to match Galileo wrappers
#define fastDigitalWrite(id, val)		fastGpioPciDigitalWrite(id, val)
#define fastDigitalRead(id)			fastGpioPciDigitalRead(id)
